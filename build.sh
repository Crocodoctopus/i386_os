...
gcc -O2 -c kernel/pic.c -o tmp/pic.o -ffreestanding -nostdlib -nostartfiles -m32 -fno-pie
...
gcc -O2 -c kernel/terminal.c -o tmp/terminal.o -ffreestanding -nostdlib -nostartfiles -m32 -fno-pie
